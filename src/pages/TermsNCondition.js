...
https://naturemonkshop.com/ ('Website'), including the related mobile site and mobile
application (hereinafter referred to as 'Platform').
        </p>
        <p>
        The Platform is owned by NatureMonk, a company incorporated under the Companies Act, 1956
with its registered office at 191 laxmi Bhavan Shiv Nagar Tarsa Road, Tahsil Parshioni,
Nagpur , Nagpur, Maharashtra - 441401 (hereinafter referred to as ‘Platform Owner’, 'we', 'us',
'our')..
        </p>
        <p>
...
These Terms of Use can be modified at any time without assigning any reason. It is you
        </p>
        <p>
...
convenience for provide further information.. You understand that upon initiating a transaction for availing the Services you are entering
...
jurisdiction of the courts in Nagpur and Maharashtra.
